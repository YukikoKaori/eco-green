...
public class WishlistPageResponse<T> {
    ...
    public static <E, R> WishlistPageResponse<R> fromPage(Page<E> page, Function<E, R> mapper) {
        return WishlistPageResponse.<R>builder()
    ...
    public static <R> WishlistPageResponse<R> of(List<R> items, int page, int size, long totalElements) {
